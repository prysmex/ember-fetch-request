export class FetchError extends Error {
  constructor(payload, message = 'Fetch operation failed', status) {
    super(message);
...
export class NetworkError extends FetchError {
  constructor(payload) {
    super(payload, payload.message, null);
  }
}
...
/**
 * Checks if the given status code or FetchError object represents a forbidden
 * request error
 */
...
/**
 * Checks if the given status code or FetchError object represents an invalid
 * request error
 */
...
/**
 * Checks if the given status code or FetchError object represents a bad request
 * error
 */
...
/**
 * Checks if the given status code or FetchError object represents a "not found"
 * error
 */
...
/**
 * Checks if the given status code or FetchError object represents a "gone"
 * error
 */
...
/**
 * Checks if the given status code or FetchError object represents a server error
 */
